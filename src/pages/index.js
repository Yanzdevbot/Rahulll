                    ...
                    <div className="md:text-xl md:w-1/2">
                        ...
                        <div className="flex flex-col">
                            <Link href="/dashboard" className="mt-4">
                                <button className="flex flex-row font-bold bg-[#483AA0] hover:bg-[#372a7a] hover:scale-105 active:scale-95 px-4 py-2 rounded-lg shadow-md transition duration-300 mt-10 items-center">
                                    Go to Dashboard 
                            ...
                            <div className="flex flex-row">
                                <Link href="/auth/login" className="mr-10">
                                    <button className="items-center flex flex-row font-bold bg-[#483AA0] hover:bg-[#372a7a] hover:scale-105 active:scale-95 px-4 py-2 rounded-lg shadow-md transition duration-300 mt-5">
                                        Login
