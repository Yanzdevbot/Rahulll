 ...
 * @returns {Promise<Array<{title: string, thumbnail: string, duration: string, uploaded: string, views: string, url: string}>|{error: boolean, message: string}>} - An array of objects containing the title, thumbnail URL, duration, uploaded timestamp, views, and URL of the video. If there is an error, return an object with error as true and a string message.
 */
