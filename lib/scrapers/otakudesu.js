...
class Otakudesu {
     ...
     * @param {string} title Title of anime to search
     * @returns {Promise<Array<Object>>} Promise that resolves to an array of search results. Each search result is an object with the following properties:
     **/
    async search(title) {
    ...
    /**
     * Get detail of anime from given URL
     * @param {string} url URL of anime page
     * @returns {Promise<Object>} Promise that resolves to an object containing detail of anime
     **/
    async detail(url) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    /**
     * Download anime from Otakudesu
     * @param {string} url - URL of the anime page on Otakudesu
     * @returns {Promise<Object>} - Object containing anime information and download links
     **/
    async download(url) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    /**
     * Get ongoing anime list from Otakudesu
     * @returns {Promise<Array<Object>>} Promise that resolves to an array of objects containing ongoing anime information
     **/
    async ongoing() {
        return new Promise((resolve, reject) => {
            axios({
